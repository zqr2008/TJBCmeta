...
# Main input(s): newdata_phylo_NMrevision_0305.rds; 3.mother2kid_share_genome.filter_0.99999_0.99.profile; genus_instrain_transmission_overall.rda
# Main output(s): genus_instrain_transmission_overall.rda; instrain_transmission_overall.csv; FigureS7B genus differences.pdf; transmissiondifferencestat.csv; plus 2 more
...
for (speciesnumber in levels(factor(inStrain_C_genome$genus))){
...
save(instrain_transmission_overall,file = "C:/Users/zqr20/Documents/tjmeta/BIG_revision/02_processed_objects/transmission_objects/genus_instrain_transmission_overall.rda")
...
################################################################################
rm(list = ls())
load("C:/Users/zqr20/Documents/tjmeta/BIG_revision/02_processed_objects/transmission_objects/genus_instrain_transmission_overall.rda")
...
ggsave("C:/Users/zqr20/Documents/tjmeta/BIG_revision/forNM_revision/FigureS7B genus differences.pdf",width = 14, height = 5)


write.table(signforstoredf, file = "C:/Users/zqr20/Documents/tjmeta/BIG_revision/04_analysis_results/transmission_results/transmissiondifferencestat.csv",
            fileEncoding = "GBK",row.names = F,col.names = T,
            quote = F,sep = ",")
